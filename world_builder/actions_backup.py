...
class SetJointPositionAction(Action):
    def __init__(self, body, position):
        ...
        if hasattr(position, 'value'):
            ...
            ## position may arrive as a string repr of an ungrounded OptimisticObject
            ## (PDDLStream converts OptimisticObject args via repr() → e.g. '#p0').
            ## Skip setting the joint; the handle attachment should have moved it correctly.
            self.position = None
